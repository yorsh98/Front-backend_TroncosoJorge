...
class BlindCvBuilder
{
    public function build(PersonProfile $profile): BlindCvProfile
    {
        $profile->load(['educations', 'workExperiences', 'certifications', 'skills', 'languages', 'desiredConditions', 'disabilityProfile']);

        return $profile->blindCvProfile()->updateOrCreate(
